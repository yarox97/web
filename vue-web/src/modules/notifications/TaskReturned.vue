<template>
  <div class="notification-body warning-theme">
    ...
    <div class="icon-area text-orange-500">
    ...
    <div class="content-area">
      <h4 class="title">Task Returned</h4>
      
      <p class="description">
        Your task in <strong>{{ payload.ClubName }}</strong> was returned for revision.
        <br>
        <span class="meta-info">Returned by: {{ assignerName }}</span>
      </p>

      <div class="task-details-box returned-box">
